...
local win = ui:new("APT脚本")
--
local UITab1 = win:Tab("『主页』",'6035145364')

local about = UITab1:section("『信息』",true)


about:Label("作者QQ：2087819028")
about:Label("QQ群：599298896")
about:Label("作者：APT")
about:Label("脚本正在更新")
about:Label("你的注入器:"..identifyexecutor())
about:Label("你的用户名:"..game.Players.LocalPlayer.Character.Name)

local UITab2 = win:Tab("『通用』",'12654158611')
...
about:Button("A1000大药水",function()
...
local UITab5 = win:Tab("后悔电梯",'12654158611')

local about = UITab5:section("后悔电梯",true)

about:Button("后悔电梯",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/474375w/jgvjyfb/refs/heads/main/jhgbtfb.lua'))()
end)

local UITab8 = win:Tab("[NEW]鱼",'12654158611')

local about = UITab8:section("[NEW]鱼",true)

about:Button("自动钓鱼（有时候会失效）",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/474375w/jgvjyfb/refs/heads/main/fish%20auto'))()
end)

about:Button("自动点摇晃",function()
local Players = game:GetService("Players")
...
local UITab9 = win:Tab("音响脚本",'12654158611')

local about = UITab9:section("这才是真正的音乐",true)

about:Button("音响（只能自己听见，输入音乐ID）",function()
...
local UITab10 = win:Tab("情云脚本专区",'12654158611')

local about = UITab10:section("脚本",true)

about:Button("情云内脏与黑火药",function()
...
about:Button("DOORS floor2脚本",function()
    loadstring(game:HttpGet("https://github.com/DocYogurt/Main/raw/main/Scripts/DF2RW.lua"))()
end)
about:Button("压力万圣节",function()
...
about:Button("压力脚本",function()
loadstring(game:HttpGet("\104\116\116\112\115\58\47\47\114\97\119\46\103\105\116\104\117\98\117\115\101\114\99\111\110\116\101\110\116\46\99\111\109\47\67\104\105\110\97\81\89\47\83\99\114\105\112\116\115\47\77\97\105\110\47\80\114\101\115\115\117\114\101\46\108\117\97\117"))()
end)
about:Button("情云脚本",function()
    loadstring(utf8.char((function() return table.unpack({108,111,97,100,115,116,114,105,110,103,40,103,97,109,101,58,72,116,116,112,71,101,116,40,34,104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,117,115,101,114,99,111,110,116,101,110,116,46,99,111,109,47,67,104,105,110,97,81,89,47,45,47,109,97,105,110,47,37,69,54,37,56,51,37,56,53,37,69,52,37,66,65,37,57,49,34,41,41,40,41})end)()))()
end)

local UITab11 = win:Tab("落叶脚本",'12654158611')

local about = UITab11:section("落叶脚本",true)

about:Button("落叶脚本",function()
...
local function resetHotbarText()
	...
	LocalPlayer.PlayerGui.ScreenGui.MagicHealth.TextLabel.Text = "无下限"
...
local UITab14 = win:Tab("其他脚本",'12654158611')

local about = UITab14:section("其他脚本",true)

about:Button("汉斯猫（不支持忍者）",function()
loadstring(game:HttpGet("https://pastefy.app/xXwLngQD/raw"))()
end)

about:Button("头部变大（范围）",function()
...
local UITab15 = win:Tab("方块故事",'12654158611')

local about = UITab15:section("方块故事",true)

about:Button("无法命中你",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/skibiditoiletfan2007/OtherScripts/main/BlockTalesGodmode.lua"))()
end)

local UITab16 = win:Tab("造船寻宝",'12654158611')

local about = UITab16:section("造船寻宝",true)

about:Button("自动刷钱",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/nainshu/no/main/zidongshuaqian"))()
end)

local UITab17 = win:Tab("巴掌",'12654158611')

local about = UITab17:section("巴掌",true)
 
about:Button("刷巴掌（需要几个手套）",function()
loadstring(game:HttpGet('https://pastefy.app/RfTh3S92/raw'))()
end)

local UITab18 = win:Tab("自然灾害模拟器",'12654158611')

local about = UITab18:section("自然灾害模拟器",true)

about:Button("一把剑",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/GenesisFE/Genesis/main/Loadstrings/Linked%20Sword"))()
end)

about:Button("雷神",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/GenesisFE/Genesis/main/Loadstrings/Lightning%20Cannon"))()
end)

local UITab19 = win:Tab("末日尖塔防御",'12654158611')

local about = UITab19:section("末日尖塔防御",true)

about:Button("刷钱（要带机枪，剑术大师，tix先生，地图选遗留底板）",function()
loadstring(game:HttpGet('https://pastebin.com/raw/E6m8U9k5'))()
end)

local UITab20 = win:Tab("躲避球",'12654158611')

local about = UITab20:section("躲避球",true)

about:Button("躲避球（第一个最后一个不要打开）",function()
...
local UITab21 = win:Tab("聊天",'16060333448')

local about = UITab21:section("聊天",true)

about:Button("聊天间谍",function()
--[[
	Simple Chat Spy
